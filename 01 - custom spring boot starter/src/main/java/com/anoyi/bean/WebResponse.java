...
import com.anoyi.service.ServiceException;
...
public class WebResponse {
     ...
     * 发生异常
     */
    public static WebResponse error(ServiceException serviceException) {
        return new WebResponse(serviceException.getCode(), serviceException.getMessage(), null);
    }
